...
if "%1"=="" (
  ...
  iverilog -o aes_dec_tb.out -I .. ..\aes_dec.v ..\aes_dec_tb.sv
...
if not "%1"=="" (
  ...
  iverilog -DGTK_WAVE -o aes_dec_tb.out -I .. ..\aes_dec.v ..\aes_dec_tb.sv
...
if exist aes_dec_tb.out vvp aes_dec_tb.out
